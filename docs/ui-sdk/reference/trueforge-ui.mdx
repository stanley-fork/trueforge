...
<ParamField path="theme" type="ThemeConfig">
  ...
  <Expandable title="ThemeConfig">
    ...
    <ParamField path="brand" type="BrandConfig">
      ...
      square mark in compact surfaces.

      <Expandable title="BrandConfig">
        <ParamField path="name" type="string">
          Optional display name and accessible image label. It appears beside the square
          icon in expanded chrome when no wide logo is configured. Omit it for icon-only
          branding.
        </ParamField>
        <ParamField path="icon" type="string | BrandLogoConfig">
          Square image used in collapsed and compact surfaces. A logo configuration
          requires this compact fallback.
        </ParamField>
        <ParamField path="logo" type="string | BrandLogoConfig">
          Optional wider image used in expanded chrome. Falls back to `icon`.
        </ParamField>
...
<TrueForgeUI
  ...
  theme={{
    preset: "claude",
    brand: { name: "Acme", icon: "/icon.svg", logo: "/wordmark.svg" },
  }}
